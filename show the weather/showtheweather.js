 ...
 var obj = {};
  ...
  obj.getLoc = function() {
    return $http.jsonp("http://ipinfo.io/json?callback=JSON_CALLBACK"); //gets the IP location of the computer browsing . 
    //also converting to http. note this is going into the object from the data at this location. and it has a property or element called CITY
  };
